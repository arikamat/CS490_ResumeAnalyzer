...
describe("Dashboard Component", () => {
  it("displays resume fit score, matched keywords, missing keywords, and improvement suggestions", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(/Your resume matches 75.50% of the job description/i),
      ).toBeInTheDocument();
    });
    ...
    expect(
      screen.getByText("Work on more challenging projects."),
    ).toBeInTheDocument();
    ...
    await waitFor(() => {
      ...
      expect(
        screen.queryByText("Computer Science Degree"),
